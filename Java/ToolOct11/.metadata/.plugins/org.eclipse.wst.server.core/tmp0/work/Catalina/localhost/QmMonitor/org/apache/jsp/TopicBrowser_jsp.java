...
public final class TopicBrowser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Topic Properties</title>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\tvar qm = document.getElementById(\"TpName\").value;\r\n");
      out.write("\tvar flag=0;\r\n");
      out.write("\tif(qm==\"TopName\"){\r\n");
      out.write("\t\tdocument.getElementById(\"span_tp\").innerHTML = \" Select Topic\";\r\n");
      out.write("\t\tflag=1;\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tdocument.getElementById(\"span_tp\").innerHTML = \"\";\r\n");
      out.write("\t}\r\n");
      out.write("\tif(flag==0){\r\n");
      out.write("\t\t//document.getElementById(\"form\").submit();\r\n");
...
response.setHeader ("Expires", "0"); //prevents caching at the proxy server 
      ...
      out.write("<tr>\r\n");
      out.write("<form id=\"form\" action=\"LoadTopics\" method=\"post\">\r\n");
...
for(String qm : QueueBrowser.getQmList()){
	if(session.getAttribute("qmName")!=null && session.getAttribute("qmName").toString().equals(qm)){
      ...
      out.write("<form id=\"form0\" action=\"GetTopicDetails\" method=\"post\" onsubmit=\"return ChChange()\">\r\n");
      out.write("<td class=\"drop\">Topic Name:<select name=\"TpName\" id=\"TpName\" >\r\n");
      out.write("<option value=\"TopName\">--Topic--</option>\r\n");
...
for(String topic : QueueBrowser.getAllTopics((String)session.getAttribute("qmName"))){
      ...
      out.write("\r\n");
      out.write("</select><font color=red><span id=\"span_tp\"></span></font></td></tr>\r\n");
