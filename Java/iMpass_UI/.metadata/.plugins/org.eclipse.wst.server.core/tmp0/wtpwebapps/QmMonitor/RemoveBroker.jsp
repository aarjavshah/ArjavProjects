...
<tr>
<td width="150px">Broker Name<font color="Red">*</font>:</td>
...
<table>
<tr>
<td width="150px"><input type="submit" name="removeBroker" id="removeBroker" value="Remove Broker" onclick="return confimation()"></td>
