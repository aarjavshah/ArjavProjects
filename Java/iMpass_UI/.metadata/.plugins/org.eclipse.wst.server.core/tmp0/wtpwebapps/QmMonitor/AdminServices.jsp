...
<ol class="tree1">
	<li>
		...
		<ol>
			...
			<li class="file"><a class="admin" href="<%=request.getContextPath()%>/BrokerUpdate" onclick="return confimation()">Retrieve Broker Components</a></li>
		</ol>
	</li>
</ol>
</td></tr><tr><td>
<ol class="tree1">
	<li>
		...
		<ol>
			...
			<li class="file"><a class="admin" href="<%=request.getContextPath()%>/QMSetup" onclick="return confimation()">Retrieve Queue-Manager Components</a></li>
