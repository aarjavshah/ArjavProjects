...
public final class RemoveBroker_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>iMPAS : Remove Broker</title>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\treturn confirm(\"This will remove the broker from the scope of the tool! Once done, the changes can not be reverted.\\nAre you sure?\");\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t\t\" This is required when an existing broker is descoped.\"+\r\n");
      out.write("\t\t\t\" You need to select the broker name from the drop down list.\"+\r\n");
      out.write("\t\t\t\" This can not be automatically reverted once it is removed. Additional information will be required to add it back to the scope.\"+\r\n");
      out.write("\t\t\t\" <br><br><strong>#This does not facilitate the deletion of an existing broker on the server, but it removes a broker from the scope of the tool.<strong> \";\r\n");
...
response.sendRedirect("Login.jsp");}
	...
	if(session.getAttribute("username")==null){
      ...
      out.write("<h1>Remove an Existing Broker<sup>#</sup></h1></td></tr><tr><td> </td></tr><tr><td> </td></tr>\r\n");
      out.write("</table>\r\n");
      out.write("<table id=\"formTable\">\r\n");
      out.write("<form action=\"RemoveBroker\" method=\"post\" onsubmit=\"return ValidateRemoveBroker()\">\r\n");
      out.write("<table id=\"adminbroker\">\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"150px\">Broker Name<font color=\"Red\">*</font>:</td>\r\n");
      out.write("<td><select name=\"broker\" id=\"broker\">\r\n");
      out.write("<option value=\"Broker\">--Broker Name--</option>\r\n");
...
for(String br:BrokerXML.RetrievebrokerList()){
      ...
      out.write("<table>\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"150px\"><input type=\"submit\" name=\"removeBroker\" id=\"removeBroker\" value=\"Remove Broker\" onclick=\"return confimation()\"></td>\r\n");
      ...
      out.write("<p >Removing an existing broker from the scope of the tool can be done from here.<span id=\"about\"></span>\r\n");
