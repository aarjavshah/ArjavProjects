...
public final class Success_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.print(session.getAttribute("reDirTo")!=null?session.getAttribute("reDirTo").toString():(session.getAttribute("home")!=null?session.getAttribute("home").toString():"" ));
      out.write("\">\r\n");
      ...
      out.write("</font></h3> \r\n");
      out.write("<a href=\"");
      out.print(session.getAttribute("home")!=null?session.getAttribute("home").toString():"Login.jsp" );
