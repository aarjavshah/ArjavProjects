...
public final class RemoveUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>iMPAS : Remove User</title>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\treturn confirm(\"This will remove the User! Once done, the changes can not be reverted.\\nAre you sure?\");\r\n");
      out.write("}\r\n");
...
response.sendRedirect("Login.jsp");}
	...
	if(session.getAttribute("username")==null){
      ...
      out.write("<h1>Remove an Existing User<sup>#</sup></h1></td></tr><tr><td> </td></tr><tr><td> </td></tr>\r\n");
      out.write("</table>\r\n");
      out.write("<table id=\"formTable\">\r\n");
      out.write("<form action=\"RemoveUser\" method=\"post\" onsubmit=\"return ValidateRemoveBroker()\">\r\n");
      out.write("<table id=\"adminbroker\">\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"94px\">User Name<font color=\"Red\">*</font>:</td>\r\n");
      out.write("<td><select name=\"user\" id=\"broker\">\r\n");
      out.write("<option value=\"Broker\">--User Name--</option>\r\n");
...
for(String usr:UserJaxB.GetUserList()){
	if(usr.equals((String)session.getAttribute("username"))){;}else{
      ...
      out.write("<table>\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"94px\"><input type=\"submit\" name=\"removeUser\" id=\"removeUser\" value=\"Remove User\" onclick=\"return confimation()\"></td>\r\n");
