...
function validate()
{
	...
	if(pass.length==0)
		{
		document.getElementById("span_pass").innerHTML="Compulsory";
		flag=1;
		}
	else if(pass.length < 8)
		{
		document.getElementById("span_pass").innerHTML="Length less than 8 !";
		flag=1;
		}
	else if(pass.length >16)
		{
		document.getElementById("span_pass").innerHTML="Length exceeds 16 !";
		flag=1;
		}
	 
	if(name.length==0)
		{
		document.getElementById("span_name").innerHTML="Compulsory";
		flag=1;
		}
...
<td>
<div id="define">
<p >Negative Fantasy League is a part of Employee Engagement Activities.<span id="about"></span>
<br style="text-align:justify;"><a href="javascript:load()" id="open"><abbr title="Click to learn more">...learn more</abbr></a>
...
<tr>
<td >
<a href="DirectPasswordReset.jsp"><font color="blue"><abbr title="Click to redirect to Forgot Password">Forgot Password</abbr></font></a>
</td>
</tr>
</table>
...
<div id="in_copy" style="text-align:=center;">
	...
	<td>
	<img src="<%= request.getContextPath()%>/profile/cognizant.png" height="50" width="60" alt="Cogni_Logo"></img>
	<tr>
	<td>
