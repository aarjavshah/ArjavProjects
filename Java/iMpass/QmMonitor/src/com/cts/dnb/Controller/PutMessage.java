...
public class PutMessage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.isNew()){
			...
			try{
				if(QueueMessenger.PutMessage((String)session.getAttribute("qmName"), (String)session.getAttribute("qName"), inMsg,replyTo)){
					...
					session.setAttribute("reDirTo", "PutMessage.jsp");
