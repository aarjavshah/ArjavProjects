...
<!--  
 * AddBatch JSP page Business Logic
 * 
 * @version 1
...
<tr><td height=30px>WEIGHT<sup><font color=red>*</font></sup><td><input type=text name=weight id="weight" autocomplete="off" placeholder="Enter Weight (1-1500)"><td><font color=red><span id="span_weight"></span></font></td>
<tr><td height=30px>PRICE<sup><font color=red>*</font></sup><td><input type=text name=price id="price" autocomplete="off" placeholder="Enter Price"><td><font color=red><span id="span_price"></span></font></td>
...
<tr><td height=30px>REFRIGERATION<td><input type=radio name=refregeration value=Yes>YES<input type=radio name=refregeration value=No checked=checked>NO
</table>
