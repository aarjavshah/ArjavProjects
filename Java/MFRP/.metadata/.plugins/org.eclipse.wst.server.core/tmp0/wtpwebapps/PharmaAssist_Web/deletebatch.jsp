...
<!--  
 * Delete Batch JSP page and business logic
 * 
 * @version 1
...
<div id="banner">
<Form action=DeleteBatch method=post onsubmit="return validate()">
<div style="height:75%;" id="out_delete">
<div id="in_delete" style="text-align:=center;">
...
<table>
<tr>
<td width="150px"><input type=button name=cancel value=CANCEL onclick="reDirect()">
<td width="100px"><input type=submit name=delete value=DELETE>
</table>
</div>
</div>
</Form>
