...
public final class searchbatch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	out.println(session.getAttribute("session_username").toString());
      ...
      out.write("\r\n");
      out.write("<Form action=SearchBatch method=post onsubmit=\"return validate()\">\r\n");
      out.write("<div style=\"height:75%;\" id=\"out_search\">\r\n");
...
for(int i=0;i<batchcode.length;i++){
	out.println("<option value="+batchcode[i]+">"+batchcode[i]); 
      ...
      out.write("<table>\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"150px\"><input type=button name=cancel value=CANCEL onclick=\"reDirect()\"></input>\r\n");
      out.write("<td width=\"100px\"><input type=submit name=search value=SEARCH>\r\n");
      out.write("</table>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      out.write("</Form>\r\n");
