...
for(String usr:UserJaxB.GetUserList()){
	if(usr.equals((String)session.getAttribute("username"))){;}else{
      ...
      out.write("<tr>\r\n");
      out.write("<td><input type=\"submit\" name=\"removeUser\" id=\"removeUser\" value=\"Remove User\" onclick=\"return confimation()\"></td>\r\n");
