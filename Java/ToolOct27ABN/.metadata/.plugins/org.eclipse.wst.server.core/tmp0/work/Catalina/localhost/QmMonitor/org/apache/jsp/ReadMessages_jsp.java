...
public final class ReadMessages_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\twindow.location=\"ReadMessages.jsp\";\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
...
if((Integer)session.getAttribute("GtCount")==(msgs.size())){
	...
	//System.out.println(session.getAttribute("BrFinish"));
      ...
      out.write("\r\n");
      out.write("<div id=\"textbox\"><strong>Reading Message ");
      out.print(session.getAttribute("GtCount") );
      out.write(" of ");
      out.print(msgs.size() );
